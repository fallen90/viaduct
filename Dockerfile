...
RUN sudo chmod +x /projects/tools/accept-licenses.sh && \
    sudo apt-get update && \
...
RUN ["/projects/tools/accept-licenses.sh","android update sdk --all --no-ui --filter platform-tools,tools,build-tools-24.0.2,android-25,android-24,android-23,android-22,android-19,android-21,extra-android-support,extra-android-m2repository,extra-google-m2repository"]
